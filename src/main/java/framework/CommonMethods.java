...
public class CommonMethods extends Baseclass{
	 ...
	 */
	public static void clickOnElementUsingActions(By element){
	 ...
	 * @param element to be clicked
	 */
	public static void clickOnElementUsingJs(By element){
	 ...
	 * @return
	 */
	public static int getIntValue(String getInt){
	 ...
	 */
	public static Boolean isElementPresent(By targetElement) throws InterruptedException{
	 ...
	 *  or during the activity.
	 */
	public static Boolean isElementNotPresent(By targetElement) throws InterruptedException{
		Boolean isPresent = (driver.findElements(targetElement).size() == 0);
		return isPresent;
	}
	 ...
	 */
	public static boolean waitForElementToBeClickable(By targetElement) {
		try{
			WebDriverWait wait = new WebDriverWait(driver, timeOut);
	 ...
	 */
	public static boolean waitForInvisibility(By targetElement) {
		try{
			WebDriverWait wait = new WebDriverWait(driver, timeOut);
	 ...
	 */
	public static void clickOnMatchingValue(List<WebElement> fetchedListElements, String valueToBeMatched){
	 ...
	 */
	public static void clickOnContainingValue(List<WebElement> fetchedListElements, String valueToBeContained){
	 ...
	 * @param selectLocator element with select tag
	 * @param valueToBeSelectedindex value to be selected
	 */

	public static void selectValuefromDropdownviabyvalue(By selectLocator, String valueToBeSelectedvalue){
		Select  selectFromDropdown = new Select(findElement(selectLocator));
		selectFromDropdown.selectByValue(valueToBeSelectedvalue);
